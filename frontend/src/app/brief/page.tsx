...
export default function WeeklyBriefPage() {
  return (
    <main className="min-h-screen p-3 sm:p-4 md:p-8 max-w-4xl mx-auto text-white">
      <h1 className="text-2xl sm:text-3xl font-black mb-4">Weekly Brief</h1>
      <section className={cardClass}>
        ...
        <div className="mt-4 grid sm:flex gap-2 sm:gap-3">
          ...
          <Link href="/socials" className="rounded-md px-4 py-2 border border-white/30 bg-black/30 text-white font-semibold text-center w-full sm:w-auto">
            Open FPL Socials
          </Link>
        </div>
      </section>
